...
CKEDITOR_CONFIGS = {
    ...
    'default': {
        ...
        'toolbar': [
            # Группа инструментов для поиска и редактирования текста: Найти, Вырезать, Копировать, Вставить, Отменить, Повторить.
            ['Find', 'Cut', 'Copy', 'Paste', 'Undo', 'Redo'],
        ...
        'embed_provider': '//noembed.com/embed?url={url}',
